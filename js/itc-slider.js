...
class ItcSlider {
  static EL_WRAPPER = 'itc-slider__wrapper';
  static EL_ITEMS = 'itc-slider__items';
  static EL_ITEM = 'itc-slider__item';
  static EL_ITEM_ACTIVE = 'itc-slider__item_active'; // Updated class name
  static EL_INDICATOR = 'itc-slider__indicator';
  static EL_INDICATOR_ACTIVE = 'itc-slider__indicator_active'; // Updated class name
  static BTN_PREV = 'itc-slider__btn_prev';
  static BTN_NEXT = 'itc-slider__btn_next';
  static BTN_HIDE = 'itc-slider__btn_hide'; // Updated class name
